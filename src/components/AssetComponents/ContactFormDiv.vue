<template>
  ...
  >
    <div class="row">
            ...
            <div class="iti iti--allow-dropdown iti--separate-dial-code">
              <div class="iti__flag-container">
                ...
                >
                  ...
                  <div class="iti__selected-dial-code">+44</div>
                  <div class="iti__arrow"></div>
                </div>
                <ul
                  class="iti__country-list iti__hide hidden"
                  id="country-listbox"
                  aria-expanded="false"
                  role="listbox"
                  aria-activedescendant="iti-item-gb"
                >
                  <li
                  ...
                  >
                    ...
                    <span class="iti__country-name"
                      >Congo (DRC) (Jamhuri ya Kidemokrasia ya Kongo)</span
                  ...
                  >
                    ...
                    <span class="iti__country-name"
                      >Saint Martin (Saint-Martin (partie française))</span
                    ><span class="iti__dial-code">+590</span>
                  </li>
                  <li
                    class="iti__country iti__standard"
                  ...
                  >
                    ...
                    <span class="iti__country-name"
                      >Saudi Arabia (‫المملكة العربية السعودية‬‎)</span
                  ...
                  >
                    ...
                    <span class="iti__country-name"
                      >United Arab Emirates (‫الإمارات العربية المتحدة‬‎)</span
              ...
              <input
                ...
                minlength="10"
                maxlength="11"
                onkeydown="checkNumberOnly(event);"
                autocomplete="off"
                style="padding-left: 83px"
                data-intl-tel-input-id="0"
                data-bv-field="phone"
              /><input type="hidden" class="phone_number" name="phone_number" />
            </div>
          </div>
        </div>
        <small
      ...
      <div class="g-recaptcha" data-sitekey="6LfxaKseAAAAALaMS5vdtseuwXBIeITE8nDIhuFH" data-callback="enableBtn" data-expired-callback="handleCallBack"></div>
    </form>

      </div>
      <div class="form-group col-md-6 text-center text-md-right">
        <button
        disabled
          type="submit"
          class="btn-custome btn waves-effect waves-light contact-custome-btn"
        >
...
export default {
  ...
  created(){
          const enableBtn = function () {document.querySelectorAll('.contact-custome-btn').forEach(el => {el.disabled = false})}
          const handleCallBack = function () {document.querySelectorAll('.contact-custome-btn').forEach(el => {el.disabled = 'disabled'})}
      window.enableBtn = enableBtn
      window.handleCallBack = handleCallBack
  },
  mounted(){
    document.querySelector('.contact-phone').addEventListener('input', e => {
      if(typeof parseInt(e.target.value) == 'number'){
        document.querySelector('.phone_number').value =  document.querySelector('.iti__selected-dial-code').innerHTML + '-' +  e.target.value
      }
    })
  },
  methods: {
    sendEmail: (_this=this) => {
      sendForm('service_241arra', 'template_ys131rl', _this.target).then(res => {
        console.log(res)

   ...
   <div class="container">
      ...
      <div class="contact-follow-us-section text-center">
         ...
         <ul class="header_social box-shadow rounded10 bg-white">
            ...
            <li><a href="https://twitter.com/mnwebbased" target="_blank" class="fab fa-twitter"><span>Twitter</span></a></li>
            <li><a href="https://www.facebook.com/mnwebbased" target="_blank" class="fab fa-facebook-f"><span>Facebook</span></a></li>
            <li><a href="#" target="_blank" class="fab fa-linkedin-in"><span>Linkedin</span></a></li>
            <li><a href="https://www.instagram.com/mnwebbased/" target="_blank" class="fab fa-instagram"><span>Instagram</span></a></li>
            <li><a href="https://www.behance.net/intelivita" target="_blank" class="fab fa-behance"><span>Behance</span></a></li>
         </ul>
      </div>
   </div>
</section>
